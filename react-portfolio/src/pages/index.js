      ...
      <main className="bg-white px-10">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10">
            <h2 className="text-5xl py-2 text-teal-600 font-medium">Sam Rodriguez</h2>
            <h3 className="text-2xl py-2">Scientist and artist.</h3>
          ...
          <div className="relative mx-auto rounded-full w-80 h-80 mt-20 overflow-hidden">
            <Image src={daisySam}   objectFit='cover' width={325} height={325} />
          </div>
        </section>
